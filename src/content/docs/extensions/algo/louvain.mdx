...
CypherDB implements a parallelized version of the Louvain algorithm based on [Grappolo](https://hpc.pnl.gov/people/hala/grappolo.html).
In CypherDB, both base and projected graphs are directed. The Louvain implementation in CypherDB operates on
