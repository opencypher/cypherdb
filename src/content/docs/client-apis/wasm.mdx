...
**Synchronous** version: [API documentation](https://kuzudb.github.io/api-docs/wasm/sync/)

**Asynchronous** version: [API documentation](https://kuzudb.github.io/api-docs/wasm/async/)
