...
CypherDB supports two list-like data types: (i) variable-length lists, simply called `LIST`, and (ii)
...
inside a `LIST` can be any of those supported by CypherDB, including nested/complex types. Some examples are shown below:
