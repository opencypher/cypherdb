...
We use [ClickBench datasets](https://github.com/ClickHouse/ClickBench/?tab=readme-ov-file#data-loading)) and the set of queries which are adapted to CypherDB's Cypher query language.
