...
Welcome! We are excited that you are interested in contributing to CypherDB.
Before submitting your contribution though, please make sure to take a moment and read through the following guidelines.

Join our project's [Discord community](https://discord.gg/neo4j) for real-time communication with contributors.
If you have a question or need help, feel free to ask in the appropriate channel or create an issue on github.

## Code of Conduct

This project and everyone participating in it is governed by a [Code of Conduct](CODE_OF_CONDUCT.md).
By participating, you are expected to uphold this code. 
Please report unacceptable behavior to [devrel@neo4j.org](mailto:devrel@neo4j.org).
...
Thank you for your contribution to CypherDB! We're grateful for your time and effort, and we look forward to working with you.
