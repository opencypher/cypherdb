---
title: "LLM extension"
description: "Access popular LLM APIs to create embeddings directly within CypherDB using Cypher"
---

import { Tabs, TabItem } from '@astrojs/starlight/components';

The `llm` extension helps you run LLM-based workflows directly within CypherDB using Cypher.
...
:::note[Note]
We plan to add more functions to this extension in the future, such as sending queries to LLMs directly from CypherDB.
:::
...
directly in CypherDB. Refer to the [vector search docs](/extensions/vector) for an example.
