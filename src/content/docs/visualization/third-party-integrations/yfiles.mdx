---
title: yFiles Jupyter Graphs for CypherDB
---

import { Tabs, TabItem } from '@astrojs/starlight/components';

[yFiles Jupyter Graphs for CypherDB](https://github.com/yWorks/yfiles-jupyter-graphs-for-kuzu) is an
open source Jupyter notebook widget that allows you to visualize CypherDB graphs from inside your Jupyter notebooks.
...
use cases, allowing users working in Python to visualize CypherDB graphs in their Jupyter notebooks. See
...
<Tabs syncKey="yfiles-installation">
<TabItem label="uv">
...
```py
import kuzu
from yfiles_jupyter_graphs_for_kuzu import CypherDBGraphWidget
...
It uses CypherDB's Python API under the hood to fetch the data as Python objects, which can be slow for
...
```py
g2 = CypherDBGraphWidget(conn, layout="tree")
...
CypherDB stores all relationships as directed, but the yFiles Jupyter Graphs widget allows you to
...
To visualize relationships as undirected, you can pass the `undirected` parameter to the `show_cypher` method:
...
Visit the yFiles Jupyter Graphs for CypherDB [GitHub page](https://github.com/yWorks/yfiles-jupyter-graphs-for-kuzu)
