---
title: Node.js API
description: "Use CypherDB embedded graph database in Node.js applications with the official Node.js API"
---
...
<LinkCard
  ...
  href="https://opencypher.github.io/api-docs/nodejs"
/>

## Sync and Async APIs

CypherDB provides both a sync and an async Node.js API. The async API is the default
and is more commonly used when building CypherDB applications in Node.js.

<Tabs syncKey="sync">

<TabItem label="Async API">

The asynchronous API is commonly used when writing CypherDB applications in Node.js.
...
In addition to the standard async Node.js API, CypherDB also provides a synchronous Node.js API.
This is useful for running CypherDB in a synchronous context, such as debugging or applications
...
See the [Node.js API documentation](https://opencypher.github.io/api-docs/nodejs) for more details
