---
title: "Client APIs"
description: "Official and community client libraries for integrating CypherDB graph database into your applications"
---

import { LinkCard, CardGrid} from '@astrojs/starlight/components';

CypherDB is embeddable in a variety of languages via client library APIs. Queries in CypherDB through
its CLI or client APIs are transactional, satisfying serializability, atomicity and durability requirements.

## Command line shell

The CypherDB CLI shell is a means to interact with a CypherDB database from the command line with zero dependencies.
