...
description: "Run CypherDB graph database in web browsers using WebAssembly for client-side graph processing"
---
...
of devices. This page describes CypherDB's Wasm API, enabling CypherDB databases to run inside Wasm-capable
browsers.

## Benefits of WASM

Several benefits of CypherDB-Wasm are the following:
...
The example can be found in [the examples directory](https://github.com/opencypher/cypherdb/tree/master/tools/wasm/examples).
...
**Synchronous** version: [API documentation](https://opencypher.github.io/api-docs/wasm/sync/)

**Asynchronous** version: [API documentation](https://opencypher.github.io/api-docs/wasm/async/)

## Local development

This section is relevant if you are interested in contributing to CypherDB's Wasm API.
