...
description: "Build indexes on string properties for efficient text search with similarity scoring"
---
...
Currently, CypherDB supports creating FTS indexes on only node tables' `STRING` properties.
...
to show all the available indexes in CypherDB, including FTS indexes.
