...
# CypherDB Node.js API

A high-performance graph database for knowledge-intensive applications. This Node.js wrapper enables interaction with the CypherDB database via JavaScript or TypeScript using either **CommonJS** or **ES Modules**.
...
```
 ✅ The dataset used in this example can be found in the [official CypherDB repository](https://github.com/kuzudb/kuzu/tree/master/dataset/demo-db/csv).
...
* [CypherDB GitHub](https://github.com/kuzudb/kuzu)
* [CypherDB Documentation](https://docs.kuzudb.com)
