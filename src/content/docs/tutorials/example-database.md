...
You can download the zipped data by clicking on [this link](https://opencypher.github.io/data/tutorial/tutorial_data.zip),
or use curl as shown below. Once downloaded, unzip the files to your current working directory.
```bash
curl -o tutorial_data.zip https://opencypher.github.io/data/tutorial/tutorial_data.zip
